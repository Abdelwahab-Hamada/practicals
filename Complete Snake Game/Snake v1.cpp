...
public:    
    ...
    inline CELL* generateFood ()
    {
        return new FOOD 
            (XY().first,XY().second);
    }
    
    inline CELL* generateStone ()
    {
        return new STONE 
            (XY().first,XY().second);
    }
    
    inline CELL* generatePoison ()
    {
        return new POISON 
            (XY().first,XY().second);
    }
